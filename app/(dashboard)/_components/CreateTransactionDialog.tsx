...
function CreateTransactionDialog({ trigger, type }: Props) {
    ...
    // query client to update data ASAP
    ...
    const onSubmit = useCallback((values: CreateTransactionSchemaType) => {
        ...
        //use server action to create txn, use mutate
        // we will send date in a new format using fun which we have defined
